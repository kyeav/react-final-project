              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="leading-relaxed max-w-3xl mb-8">
                  ...
                  {bioOffsetHeight < bioScrollHeight && (
                    <button
                      className="text-accent border-b border-accent leading-tight space-x-2"
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 max-w-3xl gap-5">
                  {/* gender, born, birthplace, known for */}
                  {cast?.gender && (
                    <MovieFact
                      name="Gender"
                      value={
                  ...
                  {cast?.birthday && (
                    <MovieFact name="Born" value={cast.birthday} />
                  )}

                  {cast?.deathday && (
                    <MovieFact name="Died" value={cast.deathday} />
                  )}

                  {cast?.place_of_birth && (
                    <MovieFact name="Birthplace" value={cast.place_of_birth} />
                  )}
